...
from .models import Imovel, Cliente, Quarto, Reserva, Funcionario

@admin.register(Imovel)
class ImovelAdmin(admin.ModelAdmin):
    list_display = ('nome', 'tipo', 'endereco', 'cidade', 'estado', 'disponivel')
...
class ReservaAdmin(admin.ModelAdmin):
    list_display = ('imovel', 'cliente', 'funcionario', 'data_inicio', 'data_fim',)
